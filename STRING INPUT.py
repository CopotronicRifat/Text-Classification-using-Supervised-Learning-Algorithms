...
print("Parts of speech tagging of training data:",post_train[0])
print("Parts of speech tagging of testing data:",post_test[0])
...
#classifier_f.close()
print("Original Naive Bayes Algorithm Accuracy for Lambda Calculas Lexical Semantic Parsing: ",(nltk.classify.accuracy(classifier,testing_set))*100)
classifier.show_most_informative_features(10)

MNB_classifier=SklearnClassifier(MultinomialNB())
MNB_classifier.train(training_set)
print("Multinomial Naive Bayes Algorithm Accuracy for Lambda Calculas Lexical Semantic Parsing: ",(nltk.classify.accuracy(MNB_classifier,testing_set))*100)
